<script lang="ts">
	...
	let { skill = 1, progress }: Props = $props();
...
<div class="reflect-progress-pill">
	<a
		href="/settings"
		class="reflect-progress-left"
		aria-label="Go to Me to see your skills progress"
	...
	<a href="/stats" class="reflect-progress-right" aria-label="Go to Insights" data-sveltekit-preload-data="off">
